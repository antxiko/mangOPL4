...
//
// Conecta el pipeline real con la BSRAM real (ymf278_slot_state) y
// expone inputs/outputs al testbench C++.
//
...
(
    ...
    // Observables
    output wire [PHASE_WIDTH-1:0]      phase_acc_out
);
    ...
    ymf278_slot_pipeline u_pipeline (
        ...
        .slot_idx         (5'd0),         // slot 0 hardcoded en 2c.3.b
        .fnum             (fnum),
        .octave           (octave),
        .key_on           (key_on),
